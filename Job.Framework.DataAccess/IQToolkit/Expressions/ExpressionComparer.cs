...
namespace IQToolkit
{
    internal class ExpressionComparer
    {
        ...
        public ExpressionComparer(ScopedDictionary<ParameterExpression, ParameterExpression> parameterScope, Func<object, object, bool> fnCompare)
        {
        ...
        protected virtual bool Compare(Expression a, Expression b)
        {
            ...
            switch (a.NodeType)
            {
                ...
                case ExpressionType.UnaryPlus: return this.CompareUnary(a as UnaryExpression, b as UnaryExpression);
                ...
                case ExpressionType.Power: return this.CompareBinary(a as BinaryExpression, b as BinaryExpression);
                case ExpressionType.TypeIs: return this.CompareTypeIs(a as TypeBinaryExpression, b as TypeBinaryExpression);
                case ExpressionType.Conditional: return this.CompareConditional(a as ConditionalExpression, b as ConditionalExpression);
                case ExpressionType.Constant: return this.CompareConstant(a as ConstantExpression, b as ConstantExpression);
                case ExpressionType.Parameter: return this.CompareParameter(a as ParameterExpression, b as ParameterExpression);
                case ExpressionType.MemberAccess: return this.CompareMemberAccess(a as MemberExpression, b as MemberExpression);
                case ExpressionType.Call: return this.CompareMethodCall(a as MethodCallExpression, b as MethodCallExpression);
                case ExpressionType.Lambda: return this.CompareLambda(a as LambdaExpression, b as LambdaExpression);
                case ExpressionType.New: return this.CompareNew(a as NewExpression, b as NewExpression);
                case ExpressionType.NewArrayInit:
                case ExpressionType.NewArrayBounds: return this.CompareNewArray(a as NewArrayExpression, b as NewArrayExpression);
                case ExpressionType.Invoke: return this.CompareInvocation(a as InvocationExpression, b as InvocationExpression);
                case ExpressionType.MemberInit: return this.CompareMemberInit(a as MemberInitExpression, b as MemberInitExpression);
                case ExpressionType.ListInit: return this.CompareListInit(a as ListInitExpression, b as ListInitExpression);
                default:
                    {
                        throw new Exception($"解析表达式目录树异常，不支持表达式 { a.NodeType } 节点类型");
                    }
            }
        }
        ...
        protected virtual bool CompareParameter(ParameterExpression a, ParameterExpression b)
        {
            ...
            {
                if (this.parameterScope.TryGetValue(a, out ParameterExpression mapped))
                {
                    return mapped == b;
                }
            }
        ...
        protected virtual bool CompareBindingList(ReadOnlyCollection<MemberBinding> a, ReadOnlyCollection<MemberBinding> b)
        {
            ...
            for (int i = 0, n = a.Count; i < n; i++)
            {
                if (this.CompareBinding(a[i], b[i]) == false)
                {
                    return false;
                }
            }
        ...
        protected virtual bool CompareBinding(MemberBinding a, MemberBinding b)
        {
            ...
            {
                case MemberBindingType.Assignment: return this.CompareMemberAssignment(a as MemberAssignment, b as MemberAssignment);
                case MemberBindingType.ListBinding: return this.CompareMemberListBinding(a as MemberListBinding, b as MemberListBinding);
                case MemberBindingType.MemberBinding: return this.CompareMemberMemberBinding(a as MemberMemberBinding, b as MemberMemberBinding);
                default:
                    {
                        throw new Exception($"解析表达式目录树异常，不支持表达式 { a.BindingType } 绑定类型");
                    }
            }
        }
        ...
        protected virtual bool CompareElementInitList(ReadOnlyCollection<ElementInit> a, ReadOnlyCollection<ElementInit> b)
        {
            ...
            for (int i = 0, n = a.Count; i < n; i++)
            {
                if (this.CompareElementInit(a[i], b[i]) == false)
                {
                    return false;
                }
            }
