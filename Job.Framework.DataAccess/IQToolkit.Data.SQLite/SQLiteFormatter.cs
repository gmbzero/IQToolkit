...
{
    internal class SQLiteFormatter : SqlFormatter
    {
        protected SQLiteFormatter(QueryLanguage language) : base(language)
        {
        ...
        protected override Expression VisitBinary(BinaryExpression b)
        {
            ...
            else if (b.NodeType == ExpressionType.Coalesce)
            {
                ...
                {
                    var rb =  right as BinaryExpression;
        ...
        protected override Expression VisitConditional(ConditionalExpression c)
        {
            if (this.IsPredicate(c.Test))
            {
                ...
                {
                    var fc =  ifFalse as ConditionalExpression;
                    this.Write(" WHEN ");
